...
export default function LinkPreview({ url, isMe }: { url: string, isMe: boolean }) {
    ...
    const isFileUrl = (url: string) => {
        const fileExtensions = [".jpg", ".jpeg", ".png", ".gif", ".bmp", ".pdf", ".doc", ".docx", ".xls", ".xlsx", ".ppt", ".pptx", ".mp4", ".mp3", ".avi", ".mov"];
    ...
    return (
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className={`text-[10px] uppercase ${isMe ? 'text-white/70' : 'text-gray-500'}`}>
