...
import type {
  ICheckUserExistPayload,
  ICreateRoomPayload,
  IJoinRoomPayload,
} from "../../../types/interfaces/IWebSocketEvent";
...
const CreateRoomPanel: React.FC<CreateRoomPanelProps> = ({
  ...
  const handleCheckUserSuccess = useCallback(
    (data: any) => {
  ...
  const handleCreateRoom = () => {
    ...
    const createRoomPayload: ICreateRoomPayload = {
      action: "onchat",
      data: {
        event: "CREATE_ROOM",
        data: {
    ...
    timeoutManager.set(
      ...
      () => {
        console.log(
          "⚠️ Timeout waiting for CREATE_ROOM response, auto-refreshing user list",
        );
        setIsLoading(false);
  ...
  const handleJoinRoom = () => {
    ...
    const joinRoomPayload: IJoinRoomPayload = {
      action: "onchat",
      data: {
        event: "JOIN_ROOM",
        data: {
    ...
    timeoutManager.set(
      ...
      () => {
        console.log(
          "⚠️ Timeout waiting for JOIN_ROOM response, auto-refreshing user list",
        );
        setIsLoading(false);
  ...
  const handleAddFriend = () => {
    ...
    const checkUserPayload: ICheckUserExistPayload = {
      action: "onchat",
      data: {
  ...
  return (
    <>
      ...
      {/* Success Toast */}
      {showSuccessToast && <ToastSuccess successMessage={successMessage} />}
    </>
  );
};
