  ...
  return (
    <>
      <div className="flex items-center gap-3 p-3 hover:bg-[var(--bg-hover)] rounded-lg cursor-pointer group transition-colors">
        ...
        <button
          className="opacity-0 group-hover:opacity-50 w-8 h-8 rounded-full hover:bg-[var(--bg-hover)] flex items-center justify-center text-[var(--text-muted)] transition-all"
